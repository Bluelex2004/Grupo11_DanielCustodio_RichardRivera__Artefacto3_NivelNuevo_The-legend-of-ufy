...
@export var gravity = 650 # Gravedad para el personaje
@export var velocity = 100 # Velocidad de movimiento en horizontal
@export var jump = 220 # Capacidad de salto, entre mayor el número más se puede saltar
